...
/**
 * Handler global para exceções relacionadas à Consulta.
 */
@RestControllerAdvice
public class ConsultaExceptionHandler {

    private static final Logger logger = LoggerFactory.getLogger(ConsultaExceptionHandler.class);

    @ExceptionHandler(ConsultaNotFoundException.class)
    public ResponseEntity<ApiErrorArray> handleTokenNotFound(ConsultaNotFoundException ex,
